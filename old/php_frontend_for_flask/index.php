...
<meta property="fb:admins" content="100002484365486"/>
<meta property="fb:app_id" content="266610213472004"/>
<script><?
...
<script type="text/javascript" src="http://desprotetor.net/static/facebox-simpletip.js"></script>
...
function formpost() {
  ...
  if ($(iddata).val().indexOf("Cole ") > -1) {var data = "";} else {var data = $(iddata).val();}
    ...
    $.post("http://desprotetor.com/deprotect?key="+_39jfe(_4fjwe7)+"&auth=<?=$getauth?>&token=<?=$gettoken ?>", { data: data },
       function(data) {
        updatepage(data);
       });         
}
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/pt_BR/all.js#xfbml=1&appId=266610213472004";
...
<div style="width:160px; height:600px; float: left; margin-bottom:20px;">
<script type="text/javascript"><!--
google_ad_client = "ca-pub-0041939178570280";
/* wide sky */
google_ad_slot = "4244693758";
google_ad_width = 160;
      ...
      <div class="formActionContainer">
        <form name="f1" id="f1">
          <div class="inputbox">
            ...
            <div class="clear" onclick='$("#formdeprotectinput").val("")'></div>
            ...
            <div class="mais"></div><div class="urls">URLs</div></a></div>
      ...
      <div class="formActionContainer">
        <form name="f1" id="f1">
          <div class="inputbox">
            ...
            <div class="menos"></div><div class="urls">URLs</div></a></div>
...
<script type="text/javascript">
  ...
  Instale a extensão do Desprotetor.com no seu navegador:
    ...
    <div style="position:absolute;top:10px;right:130px; width:50px; height:80px; text-align:center;">
      <div class="br_cont">
        <a target="_blank" href="https://chrome.google.com/webstore/detail/cocohmmjllchepkjocddkihldoiillkl"><div class="chrome"></div>
          Google Chrome
        </a>
      </div>
    </div>
...
-->
<div  style="margin-left:80px; width:840px;">
<fb:comments-count href=http://desprotetor.com/></fb:comments-count> comentários
<div class="fb-comments" data-href="http://desprotetor.com" data-width="840" data-num-posts="10"></div>
</div>
